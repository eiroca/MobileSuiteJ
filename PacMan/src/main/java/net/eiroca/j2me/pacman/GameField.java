...
public class GameField extends TiledLayer {
   ...
   */
  public GameField() {
    super(GameField.WIDTH_IN_TILES, GameField.HEIGHT_IN_TILES, BaseApp.createImage(PacManMIDlet.RES_FIELD), GameField.TILE_WIDTH, GameField.TILE_HEIGHT);
   ...
   */
  public void init() {
    BaseApp.loadTile(PacManMIDlet.RES_MAP, this);
    pills = 147;
  }
