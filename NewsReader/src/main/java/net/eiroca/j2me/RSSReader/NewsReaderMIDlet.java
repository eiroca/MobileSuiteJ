 ...
 */
public class NewsReaderMIDlet extends Application implements Comparator {
  ...
  public NewsReaderMIDlet() {
    ...
    Application.messages = BaseApp.readStrings(NewsReaderMIDlet.RES_MESSAGES);
    Application.cOK = Application.newCommand(NewsReaderMIDlet.MSG_CM_OK, Command.OK, 30, Application.AC_NONE);
    Application.cBACK = Application.newCommand(NewsReaderMIDlet.MSG_CM_BACK, Command.BACK, 20, Application.AC_BACK);
    Application.cEXIT = Application.newCommand(NewsReaderMIDlet.MSG_CM_EXIT, Command.EXIT, 10, Application.AC_EXIT);
    NewsReaderMIDlet.cADDFEEDURL = Application.newCommand(NewsReaderMIDlet.MSG_CM_ADDFEEDURL, Command.OK, 31, NewsReaderMIDlet.AC_ADDFEEDURL);
    NewsReaderMIDlet.cADDFEEDLIST = Application.newCommand(NewsReaderMIDlet.MSG_CM_ADDFEEDLIST, Command.OK, 31, NewsReaderMIDlet.AC_ADDFEEDLIST);
    NewsReaderMIDlet.cOK2 = Application.newCommand(NewsReaderMIDlet.MSG_CM_OK, Command.OK, 1, NewsReaderMIDlet.AC_DOBROWSEFEED2);
    NewsReaderMIDlet.cYES = Application.newCommand(NewsReaderMIDlet.MSG_CM_YES, Command.OK, 1, NewsReaderMIDlet.AC_YES);
    NewsReaderMIDlet.cNO = Application.newCommand(NewsReaderMIDlet.MSG_CM_NO, Command.BACK, 2, NewsReaderMIDlet.AC_NO);
    NewsReaderMIDlet.cOPEN = Application.newCommand(NewsReaderMIDlet.MSG_CM_OPEN, Command.OK, 2, NewsReaderMIDlet.AC_OPEN);
    NewsReaderMIDlet.cREAD = Application.newCommand(NewsReaderMIDlet.MSG_CM_READ, Command.OK, 2, NewsReaderMIDlet.AC_READ);
    NewsReaderMIDlet.cGO = Application.newCommand(NewsReaderMIDlet.MSG_CM_GO, Command.OK, 2, NewsReaderMIDlet.AC_GO);
    NewsReaderMIDlet.cSTOP = new Command(Application.messages[NewsReaderMIDlet.MSG_CM_STOP], Command.OK, 2);
    iBullet = BaseApp.createImage(NewsReaderMIDlet.RES_IMAGE_STAR);
    iRead = BaseApp.createImage(NewsReaderMIDlet.RES_IMAGE_READ);
    iUnread = BaseApp.createImage(NewsReaderMIDlet.RES_IMAGE_UNREAD);
    Application.menu = new short[][] {
        {
            NewsReaderMIDlet.ME_MAINMENU, NewsReaderMIDlet.MSG_ME_READFEEDS, NewsReaderMIDlet.AC_DOREADFEEDS, -1
        }, {
            NewsReaderMIDlet.ME_MAINMENU, NewsReaderMIDlet.MSG_ME_ADDFEED, NewsReaderMIDlet.AC_DOADDFEED, -1
        }, {
            NewsReaderMIDlet.ME_MAINMENU, NewsReaderMIDlet.MSG_ME_MEMORY, NewsReaderMIDlet.AC_DOMEMORY, -1
        }, {
            NewsReaderMIDlet.ME_MAINMENU, NewsReaderMIDlet.MSG_ME_CLEANUP, NewsReaderMIDlet.AC_DOCLEANUP, -1
        }, {
            NewsReaderMIDlet.ME_MAINMENU, NewsReaderMIDlet.MSG_ME_ABOUT, NewsReaderMIDlet.AC_DOABOUT, -1
        }, {
            NewsReaderMIDlet.ME_ADDFEED, NewsReaderMIDlet.MSG_ME_BROWSEFEEDS, NewsReaderMIDlet.AC_DOBROWSEFEED1, -1
        }, {
            NewsReaderMIDlet.ME_ADDFEED, NewsReaderMIDlet.MSG_ME_ADDURL, NewsReaderMIDlet.AC_DOADDURL, -1
        }, {
            NewsReaderMIDlet.ME_CLEANUP, NewsReaderMIDlet.MSG_ME_CLEANUP_ALL, NewsReaderMIDlet.AC_DOCLEANALL, -1
        }, {
            NewsReaderMIDlet.ME_CLEANUP, NewsReaderMIDlet.MSG_ME_CLEANUP_ITEMS, NewsReaderMIDlet.AC_DOCLEANITEMS, -1
        }, {
            NewsReaderMIDlet.ME_CLEANUP, NewsReaderMIDlet.MSG_ME_CLEANUP_1DOLD, NewsReaderMIDlet.AC_DOCLEAN1DOLD, -1
        }, {
            NewsReaderMIDlet.ME_CLEANUP, NewsReaderMIDlet.MSG_ME_CLEANUP_2DOLD, NewsReaderMIDlet.AC_DOCLEAN2DOLD, -1
        }, {
            NewsReaderMIDlet.ME_CLEANUP, NewsReaderMIDlet.MSG_ME_CLEANUP_1WOLD, NewsReaderMIDlet.AC_DOCLEAN1WOLD, -1
        }, {
            NewsReaderMIDlet.ME_FEEDS, NewsReaderMIDlet.MSG_NEWREAD, NewsReaderMIDlet.AC_NEWSREAD, -1
        }, {
            NewsReaderMIDlet.ME_FEEDS, NewsReaderMIDlet.MSG_NEWSUPDATE, NewsReaderMIDlet.AC_NEWSUPDATE, -1
        }, {
            NewsReaderMIDlet.ME_FEEDS, NewsReaderMIDlet.MSG_NEWSINFO, NewsReaderMIDlet.AC_NEWSINFO, -1
        }, {
            NewsReaderMIDlet.ME_FEEDS, NewsReaderMIDlet.MSG_NEWSDELETE, NewsReaderMIDlet.AC_NEWSDELETE, -1
        }, {
            NewsReaderMIDlet.ME_FEEDS, NewsReaderMIDlet.MSG_NEWSERASE, NewsReaderMIDlet.AC_NEWSERASE, -1
        }
    };
    feedsTable = RSSFeed.getIndex(this);
    String tmp;
    tmp = getAppProperty(NewsReaderMIDlet.PROP_FEEDLISTURL);
    if (tmp == null) {
      tmp = NewsReaderMIDlet.RES_FEEDSLIST;
    }
    if (tmp.startsWith(NewsReaderMIDlet.STR_HTTP)) {
      final String locale = System.getProperty(NewsReaderMIDlet.PROP_LOCALE);
      if (locale != null) {
        tmp += NewsReaderMIDlet.PRM_LOCALE + locale;
      }
    }
    NewsReaderMIDlet.stgFeedListURL = tmp;
    tmp = getAppProperty(NewsReaderMIDlet.PROP_USEHTML);
    if ((tmp == null) || (tmp.startsWith("1"))) {
      NewsReaderMIDlet.stgUseHTML = true;
    }
    else {
      NewsReaderMIDlet.stgUseHTML = false;
    }
    NewsReaderMIDlet.stgColBckG = getInt(NewsReaderMIDlet.PROP_COLBKG, NewsReaderMIDlet.stgColBckG, 16);
    NewsReaderMIDlet.stgColBord = getInt(NewsReaderMIDlet.PROP_COLBOR, NewsReaderMIDlet.stgColBord, 16);
    NewsReaderMIDlet.stgColTitl = getInt(NewsReaderMIDlet.PROP_COLTIT, NewsReaderMIDlet.stgColTitl, 16);
    NewsReaderMIDlet.stgColText = getInt(NewsReaderMIDlet.PROP_COLTXT, NewsReaderMIDlet.stgColText, 16);
  ...
  public void init() {
    ...
    while (!splashc.isDone()) {
      try {
        Thread.sleep(NewsReaderMIDlet.CHECK_SPLASH_DONETIME);
      }
      catch (final Exception e) {
        //
      }
  ...
  /** The next action. */
  private int nextAction = NewsReaderMIDlet.AC_NO;
  ...
  public boolean handleAction(int action, final Displayable d, final Command c) {
    ...
    if (action == NewsReaderMIDlet.AC_YES) {
      confirmed = true;
      action = nextAction;
    }
    if (action == NewsReaderMIDlet.AC_NO) {
    ...
    switch (action) {
      ...
      case AC_DOCLEANUP:
        ...
        break;
      case AC_DOABOUT:
        Application.show(null, Application.getTextForm(NewsReaderMIDlet.MSG_ME_ABOUT, NewsReaderMIDlet.RES_ABOUT), true);
        break;
      case AC_DOBROWSEFEED1:
        getAddFeedBrowseList();
        boolean ready = true;
        if (browseFeedList.size() == 0) {
          if (NewsReaderMIDlet.stgFeedListURL.startsWith(NewsReaderMIDlet.STR_HTTP)) {
            ready = false;
          }
          new LoadFeedsList(this, NewsReaderMIDlet.stgFeedListURL, !ready, sAddFeedBrowse);
        }
        if (ready) {
      ...
      case AC_DOCLEANALL:
        if (confirmed) {
          ...
          o[0] = new Integer(nf);
          o[1] = new Integer(ni);
          deltext = Application.format(NewsReaderMIDlet.MSG_DELETEALL, o);
        }
        else {
          confirm(NewsReaderMIDlet.MSG_CONFIRM, NewsReaderMIDlet.MSG_SUREDELETEALL, NewsReaderMIDlet.cYES, NewsReaderMIDlet.cNO);
        }
        break;
      case AC_DOCLEANITEMS:
        if (confirmed) {
          ni = RSSItem.deleteAll();
          o[0] = new Integer(ni);
          deltext = Application.format(NewsReaderMIDlet.MSG_DELETEITEMS, o);
        }
        else {
          confirm(NewsReaderMIDlet.MSG_CONFIRM, NewsReaderMIDlet.MSG_SUREDELETEALLITEMS, NewsReaderMIDlet.cYES, NewsReaderMIDlet.cNO);
        }
        break;
      case AC_DOCLEAN1DOLD:
        if (confirmed) {
          ni = RSSItem.deleteItems(new ItemFilter(System.currentTimeMillis() - NewsReaderMIDlet.DAYMILLIS));
          o[0] = new Integer(ni);
          deltext = Application.format(NewsReaderMIDlet.MSG_DELETEITEMS, o);
        }
        else {
          confirm(NewsReaderMIDlet.MSG_CONFIRM, NewsReaderMIDlet.MSG_SUREDELETEITEMS, NewsReaderMIDlet.cYES, NewsReaderMIDlet.cNO);
        }
        break;
      case AC_DOCLEAN2DOLD:
        if (confirmed) {
          ni = RSSItem.deleteItems(new ItemFilter(System.currentTimeMillis() - (2 * NewsReaderMIDlet.DAYMILLIS)));
          o[0] = new Integer(ni);
          deltext = Application.format(NewsReaderMIDlet.MSG_DELETEITEMS, o);
        }
        else {
      ...
      case AC_DOCLEAN1WOLD:
        if (confirmed) {
          ni = RSSItem.deleteItems(new ItemFilter(System.currentTimeMillis() - (7 * NewsReaderMIDlet.DAYMILLIS)));
          o[0] = new Integer(ni);
          deltext = Application.format(NewsReaderMIDlet.MSG_DELETEITEMS, o);
        }
        else {
      ...
      case AC_NEWSDELETE:
        ...
        o[0] = new Integer(ni);
        final String deletetext = Application.format(NewsReaderMIDlet.MSG_DELETEITEMS, o);
        final Alert newalert = new Alert(Application.messages[NewsReaderMIDlet.MSG_NEWSDELETE], deletetext, null, AlertType.INFO);
      ...
      case AC_GO:
        try {
          ...
          if (currentFeed.type.startsWith(RSSFeed.WEB_ITEM)) {
            link = NewsReaderMIDlet.STR_GOOGLE + BaseApp.URLEncode(link);
          }
    ...
    if (deltext != null) {
      final Alert newalert = new Alert(Application.messages[NewsReaderMIDlet.MSG_DELETED]);
      newalert.setTimeout(Alert.FOREVER);
  ...
  public void changed(final int event, final Displayable previous, final Displayable next) {
    if (event == Application.EV_BEFORECHANGE) {
      if (next == sFeedMenu) {
        ...
        o[0] = new Integer(nr);
        o[1] = new Integer(nn);
        sFeedMenu.insert(0, Application.format(NewsReaderMIDlet.MSG_NEWREAD, o), null);
        if (nr > 0) {
        ...
        if (browseFeedList.size() == 0) {
          sAddFeedBrowse.append(Application.messages[NewsReaderMIDlet.MSG_FEEDFILEERROR], null);
          sAddFeedBrowse.removeCommand(NewsReaderMIDlet.cADDFEEDLIST);
        }
        else {
          RSSFeed feed;
          ...
          sAddFeedBrowse.addCommand(NewsReaderMIDlet.cADDFEEDLIST);
        }
      }
    }
  }
  ...
  public final static long MINMILLIS = NewsReaderMIDlet.SECMILLIS * 60;

  /** The Constant HOURMILLIS. */
  public final static long HOURMILLIS = NewsReaderMIDlet.MINMILLIS * 60;

  /** The Constant DAYMILLIS. */
  public final static long DAYMILLIS = NewsReaderMIDlet.HOURMILLIS * 24;
  ...
  public static String timeDiff(long start, final long stop) {
    start = stop - start;
    String diff = NewsReaderMIDlet.STR_EMPTY;
    if (start >= NewsReaderMIDlet.DAYMILLIS) {
      diff += (start / NewsReaderMIDlet.DAYMILLIS) + "d ";
    }
    if (start >= NewsReaderMIDlet.HOURMILLIS) {
      diff += (start % NewsReaderMIDlet.DAYMILLIS) / NewsReaderMIDlet.HOURMILLIS + "h ";
    }
    if (start >= NewsReaderMIDlet.MINMILLIS) {
      diff += (start % NewsReaderMIDlet.HOURMILLIS) / NewsReaderMIDlet.MINMILLIS + "m ";
    }
    if (start >= NewsReaderMIDlet.SECMILLIS) {
      diff += (start % NewsReaderMIDlet.MINMILLIS) / NewsReaderMIDlet.SECMILLIS + "s ";
    }
    diff += "ago";
    return diff;
  }
  ...
  private Alert addFeedURL() {
    ...
    if ((newtitle.length() > 0) && (newurl.length() > 7)) {
      ...
      if ((feedsTable == null) || (BaseApp.find(feedsTable, p, this) == -1)) {
        ...
        addedfeeds++;
        // Clear the Form
        iTitle.setString(NewsReaderMIDlet.STR_EMPTY);
        iURL.setString(Application.messages[NewsReaderMIDlet.MSG_FM_HTTP]);
      }
    }
    return buildAlert(addedfeeds);
  }
  ...
  private Alert buildAlert(final int addedFeeds) {
    ...
    if (addedFeeds > 0) {
      ...
      addalert = new Alert(Application.messages[NewsReaderMIDlet.MSG_ERR01_TIT], Application.format(NewsReaderMIDlet.MSG_ERR01_MSG, o), null, AlertType.INFO);
    }
    else if (addedFeeds == -1) {
      addalert = new Alert(Application.messages[NewsReaderMIDlet.MSG_ERR02_TIT], Application.messages[NewsReaderMIDlet.MSG_ERR02_MSG], null, AlertType.ERROR);
    }
    else {
      addalert = new Alert(Application.messages[NewsReaderMIDlet.MSG_ERR03_TIT], Application.messages[NewsReaderMIDlet.MSG_ERR03_MSG], null, AlertType.ERROR);
    }
  ...
  private List getMainMenu() {
    if (sMainMenu == null) {
      sMainMenu = Application.getMenu(Application.messages[NewsReaderMIDlet.MSG_APPLICATION], NewsReaderMIDlet.ME_MAINMENU, -1, Application.cEXIT);
    }
    return sMainMenu;
  }
  ...
  private List getAddFeedMenu() {
    if (sAddFeedMenu == null) {
      sAddFeedMenu = Application.getMenu(Application.messages[NewsReaderMIDlet.MSG_ME_ADDFEED], NewsReaderMIDlet.ME_ADDFEED, -1, Application.cBACK);
    }
    return sAddFeedMenu;
  }
  ...
  private Form getAddFeedURL() {
    if (sAddFeedURL == null) {
      iTitle = new TextField(Application.messages[NewsReaderMIDlet.MSG_FM_FEEDTITLE], NewsReaderMIDlet.STR_EMPTY, 64, TextField.ANY);
      iURL = new TextField(Application.messages[NewsReaderMIDlet.MSG_FM_FEEDURL], Application.messages[NewsReaderMIDlet.MSG_FM_HTTP], 256, TextField.URL);
      sAddFeedURL = new Form(Application.messages[NewsReaderMIDlet.MSG_FM_ADDFEED]);
      Application.setup(sAddFeedURL, Application.cBACK, NewsReaderMIDlet.cADDFEEDURL);
  ...
  /**
   * Returns a list with feeds read from a file. It also fills the feedtable (Hashtable) with the
   * feed titles->feed urls.
   * @return the list of feed titles
   */
  private List getAddFeedBrowseList() {
    sAddFeedBrowse = new List(Application.messages[NewsReaderMIDlet.MSG_SOMEFEEDS], Choice.MULTIPLE);
  ...
  private List getCleanUpMenu() {
    if (sCleanUpMenu == null) {
      sCleanUpMenu = Application.getMenu(Application.messages[NewsReaderMIDlet.MSG_ME_CLEANUP], NewsReaderMIDlet.ME_CLEANUP, -1, Application.cBACK);
    }
    return sCleanUpMenu;
  }
  ...
  public Form getMemoryForm() {
    System.gc();
    final Form sMemory = new Form(Application.messages[NewsReaderMIDlet.MSG_ME_MEMORY]);
    ...
    if (infoFeed != null) {
      ...
      sb.append(Application.messages[NewsReaderMIDlet.MSG_DBINFO1]);
      sb.append(BaseApp.CR);
      o[0] = new Integer(infoFeed.numRec);
      sb.append(Application.format(NewsReaderMIDlet.MSG_DBINFO2, o));
      sb.append(BaseApp.CR);
      o[0] = new Integer(info.numRec);
      sb.append(Application.format(NewsReaderMIDlet.MSG_DBINFO3, o));
      sb.append(BaseApp.CR);
      o[0] = new Integer(info.used / 1024);
      sb.append(Application.format(NewsReaderMIDlet.MSG_DBINFO4, o));
      sb.append(BaseApp.CR);
      o[0] = new Integer(info.avail / 1024);
      sb.append(Application.format(NewsReaderMIDlet.MSG_DBINFO5, o));
      sb.append(BaseApp.CR);
      sMemory.append(sb.toString());
    }
    sb = new StringBuffer(300);
    sb.append(Application.messages[NewsReaderMIDlet.MSG_MEMINFO1]);
    sb.append(BaseApp.CR);
    o[0] = new Integer((int)used);
    sb.append(Application.format(NewsReaderMIDlet.MSG_MEMINFO2, o));
    sb.append(BaseApp.CR);
    o[0] = new Integer((int)free);
    sb.append(Application.format(NewsReaderMIDlet.MSG_MEMINFO3, o));
    sb.append(BaseApp.CR);
    sMemory.append(sb.toString());
  ...
  private List getSelectFeed() {
    ...
    /* Reset the List */
    final List sSelectFeed = new List(Application.messages[NewsReaderMIDlet.MSG_FEEDS], Choice.IMPLICIT);
    /* Update the hashtable with all the feeds */
    feedsTable = RSSFeed.getIndex(this);
    if ((feedsTable == null) || feedsTable.isEmpty()) {
      sSelectFeed.setSelectCommand(null);
      sSelectFeed.append(Application.messages[NewsReaderMIDlet.MSG_ERRNOFEEDS], null);
    }
    else {
      sSelectFeed.setSelectCommand(NewsReaderMIDlet.cOPEN);
  ...
  /**
   * Returns a list with feed options. The list is always refreshed when this method is called, so
   * that the number of new items are correct.
   * @return the refreshed list of feed options
   */
  protected List getFeedMenu() {
    if (sFeedMenu == null) {
      sFeedMenu = Application.getMenu(NewsReaderMIDlet.STR_EMPTY, NewsReaderMIDlet.ME_FEEDS, -1, Application.cBACK);
    }
    return sFeedMenu;
  }

  /**
   * Returns a form with the current feed info. The form is always refreshed when this method is
   * called.
  ...
  private Form getFeedInfo() {
    ...
    feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO01, o));
    feedinfo.append(BaseApp.CR);
    if ((currentFeed.lastUpdateTime > 0)) {
      o[0] = NewsReaderMIDlet.timeDiff(currentFeed.lastUpdateTime, System.currentTimeMillis());
      feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO02, o));
      feedinfo.append(BaseApp.CR);
    }
    o[0] = new Integer(currentFeed.minsBetweenUpdates);
    feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO03, o));
    feedinfo.append(BaseApp.CR);
    o[0] = new Integer(currentFeed.getItemsCount());
    feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO04, o));
    feedinfo.append(BaseApp.CR);
    if (!currentFeed.lastBuildDate.equals(NewsReaderMIDlet.STR_EMPTY)) {
      o[0] = currentFeed.lastBuildDate;
      feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO05, o));
      feedinfo.append(BaseApp.CR);
    }
    if ((currentFeed.lastFeedLen > 0)) {
      o[0] = new Integer((int)(currentFeed.lastFeedLen / 1024));
      feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO06, o).toString());
      feedinfo.append(BaseApp.CR);
    }
    o[0] = currentFeed.URL;
    feedinfo.append(Application.format(NewsReaderMIDlet.MSG_FEEDINFO07, o));
  ...
  private List getNewsList(final boolean keepPos) {
    ...
    sNewsList.removeCommand(NewsReaderMIDlet.cREAD);
    // Add content to the list
    if ((currentFeed == null) || (currentFeed.getItemsCount() == 0)) {
      sNewsList.append(Application.messages[NewsReaderMIDlet.MSG_NOITEMS], null);
    }
    else {
      final int nrofitems = currentFeed.getItemsCount();
      final int start = page * NewsReaderMIDlet.ITEMXPAGE;
      int n;
      if ((start + NewsReaderMIDlet.ITEMXPAGE) >= nrofitems) {
        n = nrofitems - start;
        hasNext = false;
      }
      else {
        hasNext = true;
        n = NewsReaderMIDlet.ITEMXPAGE;
      }
      int base = 0;
      if (page > 0) {
        base = 1;
      ...
      sNewsList.setSelectCommand(NewsReaderMIDlet.cREAD);
      RSSItem tmpitem;
      Image img;
      // Add all the items to the itemlist and to the table
      if (hasPrev) {
        sNewsList.append(Application.messages[NewsReaderMIDlet.MSG_PREV], null);
      }
      for (int i = 0; i < n; i++) {
      ...
      if (hasNext) {
        nextIdx = sNewsList.append(Application.messages[NewsReaderMIDlet.MSG_NEXT], null);
      }
      else {
        nextIdx = -1;
      }
  ...
  /**
   * Returns a form with the given item info. The form is always refreshed when this method is
   * called.
   * 
  ...
  public Displayable getNewsDataTEXT() {
    ...
    if (!currentItem.description.equals(NewsReaderMIDlet.STR_EMPTY)) {
    ...
    if ((currentItem.image != null) && (!currentItem.image.equals(NewsReaderMIDlet.STR_EMPTY))) {
      // Handle the Image
    }
    // Print the published date if it exists
    if (!currentItem.pubDate.equals(NewsReaderMIDlet.STR_EMPTY)) {
      o[0] = currentItem.pubDate;
      itemform.append(Application.format(NewsReaderMIDlet.MSG_FEEDITEMINFO01, o));
      itemform.append(BaseApp.sCR);
    }
    if ((currentItem.link != null) && (!currentItem.link.equals(NewsReaderMIDlet.STR_EMPTY))) {
      itemform.addCommand(NewsReaderMIDlet.cGO);
    }
    else {
      itemform.removeCommand(NewsReaderMIDlet.cGO);
    }
    ...
    o[2] = NewsReaderMIDlet.timeDiff(currentItem.parseTime, System.currentTimeMillis());
    itemform.append(Application.format(NewsReaderMIDlet.MSG_FEEDITEMINFO02, o));
    return itemform;
  }
