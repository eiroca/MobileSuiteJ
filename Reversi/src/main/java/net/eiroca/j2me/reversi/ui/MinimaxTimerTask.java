/**
 * GPL >= 3.0 Copyright (C) 2006-2010 eIrOcA (eNrIcO Croce & sImOnA Burzio) Copyright (C) 2002-2004
 * Salamon Andras
 *
...
public class MinimaxTimerTask extends TimerTask {
  ...
  public boolean cancel() {
    ReversiScreen.LOGIC.cancel(true);
    return true;
  }
  ...
  public void run() {
    ended = false;
    ReversiScreen.LOGIC.foreMinimax(ReversiScreen.getActSkill(), startTable, ReversiScreen.getActPlayer(), ReversiScreen.rgame, true, 0, true, true);
    System.gc();
    ended = true;
  }
