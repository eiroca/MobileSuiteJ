...
public final class AddressStore extends Store {
  ...
  /**
   * Creates new <code>AddressStoreImpl</code> instance. The additional string parameter allows us
   * to create different AddressStores (for example different address books).
   * 
