...
public class PINChangeScreen extends Form {
  ...
  public PINChangeScreen(final int title) {
    ...
    append(Application.messages[SecureSMSMIDlet.MSG_INSERTPINTEXT]);
    pinText = new TextField(Application.messages[SecureSMSMIDlet.MSG_PIN], "", PINChangeScreen.MAX_PIN_LENGTH, TextField.NUMERIC);
    append(pinText);
    Application.setup(this, Application.cBACK, SecureSMSMIDlet.cPINSAV);
    setPIN(null);
  }
  ...
  public void setPIN(final String pin) {
    if (pin == null) {
      pinText.setString("");
      removeCommand(SecureSMSMIDlet.cPINDEL);
    }
    else {
      pinText.setString(pin);
      addCommand(SecureSMSMIDlet.cPINDEL);
    }
  }
