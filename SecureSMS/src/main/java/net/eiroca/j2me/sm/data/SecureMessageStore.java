...
/**
 * Implementation of the MessageStore interface. Note: this implementation may be platform-specific
 * even if it uses the RMS.
 */
public final class SecureMessageStore extends Store {

  /**
   * Creates new <code>MessageStoreImpl</code> instance. The additional string parameter allows us
   * to create different MessageStores (different folders).
   * 
